...
alias wordpress='cd /var/www/localhost/cms/Wordpress'
alias wordpress.tst='cd /var/www/localhost/cms/Wordpress/WP_Test/wordpress.tst'
alias apache-dir='cd /etc/apache2'
alias apache.conf='sudo vim /etc/apache2/apache2.conf'
alias apache.site.conf='cd /etc/apache2/sites-available/'
alias framework='cd /var/www/localhost/frameworks'
alias laravel-dir='cd /var/www/localhost/frameworks/laravel'
alias 'test.local'='cd /var/www/localhost/htdocs/test.local'
...
#----------------------------------------------------
# Source global definitions (Aliases session_end)   #
#----------------------------------------------------
...
echo -e "${BCyan}BASH Version ${BRed}${BASH_VERSION%.*} ${BCyan}\
...
#export BASH_IT="/home/Jack/.bash_it"
#
